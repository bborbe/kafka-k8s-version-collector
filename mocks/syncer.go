...
func (fake *Syncer) Sync(arg1 context.Context) error {
	fake.syncMutex.Lock()
...
func (fake *Syncer) SyncCalls(stub func(context.Context) error) {
	fake.syncMutex.Lock()
	defer fake.syncMutex.Unlock()
	fake.SyncStub = stub
}

func (fake *Syncer) SyncArgsForCall(i int) context.Context {
	fake.syncMutex.RLock()
	defer fake.syncMutex.RUnlock()
...
func (fake *Syncer) SyncReturns(result1 error) {
	fake.syncMutex.Lock()
	defer fake.syncMutex.Unlock()
	fake.SyncStub = nil
...
func (fake *Syncer) SyncReturnsOnCall(i int, result1 error) {
	fake.syncMutex.Lock()
	defer fake.syncMutex.Unlock()
	fake.SyncStub = nil
...
var _ version.Syncer = new(Syncer)
